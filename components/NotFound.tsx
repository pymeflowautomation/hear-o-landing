...
const NotFound: React.FC<NotFoundProps> = ({ onContact }) => (
  <div className="min-h-screen bg-slate-950 text-white pt-32">
    <Helmet>
      <title>Pagina no encontrada | Hear-O</title>
      <meta name="robots" content="noindex, follow" />
    </Helmet>
    <LandingHeader onContactClick={onContact} />
    <main className="container mx-auto px-6 lg:px-20 pb-24 text-center">
      <h1 className="text-4xl md:text-6xl font-bold mb-6">Pagina no encontrada</h1>
      <p className="text-xl text-slate-400 mb-8">Esta direccion no existe, pero puedes volver al ecosistema Hear-O.</p>
